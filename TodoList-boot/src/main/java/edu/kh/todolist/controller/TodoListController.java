...
@Slf4j
@RequestMapping("todo") // todo로 시작하는 주소 매핑
@Controller // Controller 임을 명시 + Bean 등록 (IOC, 객체 생성 및 관리를 Spring이 함)
public class TodoListController {
	
	@Autowired // 등록된 Bean 중에서 같은 타입의 객체를  의존성 주입 (DI)
	...
	/** 상세 조회
	 * @param todoNo : 조회 할 일의 PK 번호(@PathVariable 이용)
