...
public class ParameterController {
	...
	//	@RequestMapping(value = "test1", method = RequestMethod.@GetMapping("path")
	@GetMapping("test1")
	...
	public String test4(
		 ...
		 * -> 제출되는 값이 존재하기 때문에
		 *    @RequestParam()의 아무 속성을 적지 않아도 잘 얻어와진다!!
		 * 
